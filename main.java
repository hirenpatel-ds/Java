...
public class main {
    public static void main(String args[]) {
        ...
        long a = 32;
        int b = a;
        System.out.println(b); // this will raise an error because we are implementing long value in int

        // implicit type conversion / widenning conversion
        float f = sc.nextInt(); // we are taking int from user and assign it into a float datatype
        System.out.println(f); // this will return float value which is implicit type casting
